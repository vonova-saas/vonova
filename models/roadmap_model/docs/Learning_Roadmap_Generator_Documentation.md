...
This documentation covers the main modules: `main.py`, `services/roadmap_generator.py`, `models/roadmap_schema.py`, and other supporting modules. Together, they implement the core functionality of the application, including the API endpoint, request handling, roadmap generation, and response formatting.
