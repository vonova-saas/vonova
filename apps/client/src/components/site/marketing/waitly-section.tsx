...
import Countdown from "@/components/site/waitlist/countdown";
import People from "@/components/site/waitlist/people";
import Form from "@/components/site/waitlist/form";
