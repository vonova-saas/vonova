...
export default function People({
	...
	const avatars = [
		{ id: "avatar1", src: "/images/avatars/avatar1.avif" },
		{ id: "avatar2", src: "/images/avatars/avatar2.avif" },
		{ id: "avatar3", src: "/images/avatars/avatar3.avif" },
		{ id: "avatar4", src: "/images/avatars/avatar4.avif" },
	];
