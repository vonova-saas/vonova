...
export default function DashboardLayoutClient({ children }: Props) {
  ...
  const adminDashboardSections = [
    { name: "System Overview", url: "/admin/:adminId" },
    { name: "Logging & Monitoring", url: "/admin/:adminId/logging-monitoring" },
    { name: "Security Logs", url: "/admin/:adminId/security-logs" },
    { name: "Performance Metrics", url: "/admin/:adminId/performance-metrics" },
    { name: "User Management", url: "/admin/:adminId/user-management" },
    { name: "Reports", url: "/admin/:adminId/reports" },
                    ...
                    <Breadcrumb>
                      <BreadcrumbList className="flex-nowrap overflow-x-auto py-1 scrollbar-hide">
                        ...
                        {crumbSegments.map((segment, index) => {
                          ...
                          const displayName =
                            currentSegmentMap[
                              segment as keyof typeof currentSegmentMap
                            ] || segment;
                          ...
                          return (
                            <React.Fragment key={segment}>
                              ...
                              <BreadcrumbItem className="whitespace-nowrap">
                                ...
                                >
                                  {isMobile && crumbSegments.length > 1 && isLast
                                    ? "..."
                                    : displayName}
                                </BreadcrumbLink>
                              </BreadcrumbItem>
