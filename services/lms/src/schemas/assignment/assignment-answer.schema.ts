...
export const AssignmentAnswerItemSchema = SchemaFactory.createForClass(AssignmentAnswerItemClass);
...
export class AssignmentAnswer extends Document implements AssignmentAnswerDocument {
...
export const AssignmentAnswerSchema = SchemaFactory.createForClass(AssignmentAnswer);
