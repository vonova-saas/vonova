...
export class ContentController {
  ...
  async getCourseContentTree(@Payload() data: { courseId: string; userId: string }) {
  ...
  async getLessonContent(@Payload() data: { courseId: string; lessonId: string; userId: string }) {
