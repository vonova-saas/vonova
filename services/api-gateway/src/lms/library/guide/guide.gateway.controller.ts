...
export class GuideGatewayController {
  ...
  @ApiOperation({
    ...
    description: 'Creates a new guide with title, authors, topics, and optional metadata.',
  })
  @ApiResponse({
    status: 201,
    ...
    schema: {
      ...
      properties: {
        ...
        summary: { type: 'string', example: 'A comprehensive guide to learning JavaScript.' },
        description: { type: 'string', example: 'This guide covers everything from basics to advanced.' },
        authors: {
          type: 'array',
          items: {
            type: 'object',
        ...
        coverUrl: { type: 'string', example: 'https://example.com/guide-cover.jpg' },
        language: { type: 'string', example: 'en' },
        badges: { type: 'array', items: { type: 'string' }, example: ['featured'] },
