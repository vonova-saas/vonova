...
export class CourseGatewayController {
  ...
  @ApiOperation({
    ...
    description: 'Creates a new course with title, pricing, and optional metadata.',
  })
  @ApiResponse({
    status: 201,
    ...
    schema: {
      ...
      properties: {
        ...
        smallDescription: { type: 'string', example: 'Learn JavaScript from scratch.' },
        description: { type: 'string', example: 'Comprehensive JavaScript course.' },
        difficulty: { type: 'string', example: 'Intermediate' },
        categoryId: { type: 'string', example: '507f1f77bcf86cd799439011' },
        tags: { type: 'array', items: { type: 'string' }, example: ['javascript', 'web-development'] },
        thumbnailUrl: { type: 'string', example: 'https://example.com/thumbnail.jpg' },
        trailerUrl: { type: 'string', example: 'https://example.com/trailer.mp4' },
